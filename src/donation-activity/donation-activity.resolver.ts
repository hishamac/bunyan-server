...
import { DonationActivity } from './entities/donation-activity.entity';
...
@Resolver(() => DonationActivity)
export class DonationActivityResolver {
  constructor(
  ...
  @Query(() => [DonationActivity], { name: 'donationActivities' })
  findAll(
    ...
    return this.donationActivityService.findAll(
      limit,
      offset,
      filters,
      orderBy,
