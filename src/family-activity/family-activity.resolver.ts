...
import { FamilyActivity } from './entities/family-activity.entity';
...
@Resolver(() => FamilyActivity)
export class FamilyActivityResolver {
  constructor(
    private readonly familyActivityService: FamilyActivityService,
  ) {}
  ...
  @Query(() => [FamilyActivity], { name: 'familyActivities' })
  findAll(
    ...
    return this.familyActivityService.findAll(
      limit,
      offset,
      filters,
      orderBy,
