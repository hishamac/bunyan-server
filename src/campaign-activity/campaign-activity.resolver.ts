...
@Resolver(() => CampaignActivity)
export class CampaignActivityResolver {
  constructor(
  ...
  @Query(() => [CampaignActivity], { name: 'campaignActivities' })
  findAll(
    ...
    return this.campaignActivityService.findAll(
      limit,
      offset,
      filters,
      orderBy,
