...
import { TaskParticipantActivity } from './entities/task-participant-activity.entity';
...
@Resolver(() => TaskParticipantActivity)
export class TaskParticipantActivityResolver {
  constructor(
    private readonly taskParticipantActivityService: TaskParticipantActivityService,
  ) {}
  ...
  @Query(() => [TaskParticipantActivity], { name: 'taskParticipantActivities' })
  findAll(
    ...
    return this.taskParticipantActivityService.findAll(
      limit,
      offset,
      filters,
      orderBy,
