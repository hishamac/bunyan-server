...
import { VillageActivity } from './entities/village-activity.entity';
...
@Resolver(() => VillageActivity)
export class VillageActivityResolver {
  constructor(
    private readonly villageActivityService: VillageActivityService,
  ) {}
  ...
  @Query(() => [VillageActivity], { name: 'villageActivities' })
  findAll(
    ...
    return this.villageActivityService.findAll(
      limit,
      offset,
      filters,
      orderBy,
