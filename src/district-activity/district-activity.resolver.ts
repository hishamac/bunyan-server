...
import { DistrictActivity } from './entities/district-activity.entity';
...
@Resolver(() => DistrictActivity)
export class DistrictActivityResolver {
  constructor(
    private readonly districtActivityService: DistrictActivityService,
  ) {}
  ...
  @Query(() => [DistrictActivity], { name: 'districtActivities' })
  findAll(
    ...
    return this.districtActivityService.findAll(
      limit,
      offset,
      filters,
      orderBy,
