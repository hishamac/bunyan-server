...
import { CharityActivity } from './entities/charity-activity.entity';
...
@Resolver(() => CharityActivity)
export class CharityActivityResolver {
  constructor(
    private readonly charityActivityService: CharityActivityService,
  ) {}
  ...
  @Query(() => [CharityActivity], { name: 'charityActivities' })
  findAll(
    ...
    return this.charityActivityService.findAll(
      limit,
      offset,
      filters,
      orderBy,
